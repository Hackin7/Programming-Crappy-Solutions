x""" SPI - Simple Pascal Interpreter. Part 14."""
...
class SemanticAnalyzer(NodeVisitor):
    ...
    def visit_Program(self, node):
        ...
        ### 1. Initialising Built-in Scope##################################
        built_ins = ScopedSymbolTable(
            scope_name='built_ins',
            scope_level=0,
            enclosing_scope=self.current_scope, # None
        )
        self.current_scope = built_ins
        built_ins._init_builtins()
        #####################################################################
