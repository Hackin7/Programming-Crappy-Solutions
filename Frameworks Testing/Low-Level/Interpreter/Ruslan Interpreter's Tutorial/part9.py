'''
Solutions to exercises from https://ruslanspivak.com/lsbasi-part9/
...
RESERVED_KEYWORDS = {
    ...
    'END': Token('END', 'END'),
    'DIV': Token(DIV, 'DIV') # Div for integer division
}
...
class Lexer(object):
    ...
    def _id(self):
        ...
        result = ''
        ### Allow variables to start with an underscore #############
        ...
        '''
        for word, reserved_token in RESERVED_KEYWORDS.items():
            if result.upper() == word:
