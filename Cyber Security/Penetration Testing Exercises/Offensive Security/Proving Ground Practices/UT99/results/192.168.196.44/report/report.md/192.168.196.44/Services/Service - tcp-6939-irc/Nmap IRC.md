```bash
nmap -vv --reason -Pn -T4 -sV --script irc-botnet-channels,irc-info,irc-unrealircd-backdoor -oN "/media/sf_Stuff1/Github/Solutions/Cyber Security/Penetration Testing Exercises/Offensive Security/Proving Ground Practices/UT99/results/192.168.196.44/scans/tcp6939/tcp_6939_irc_nmap.txt" -oX "/media/sf_Stuff1/Github/Solutions/Cyber Security/Penetration Testing Exercises/Offensive Security/Proving Ground Practices/UT99/results/192.168.196.44/scans/tcp6939/xml/tcp_6939_irc_nmap.xml" -p 6939 192.168.196.44
```

[/media/sf_Stuff1/Github/Solutions/Cyber Security/Penetration Testing Exercises/Offensive Security/Proving Ground Practices/UT99/results/192.168.196.44/scans/tcp6939/tcp_6939_irc_nmap.txt](file:///media/sf_Stuff1/Github/Solutions/Cyber Security/Penetration Testing Exercises/Offensive Security/Proving Ground Practices/UT99/results/192.168.196.44/scans/tcp6939/tcp_6939_irc_nmap.txt):
...
6939/tcp open  unknown syn-ack ttl 127
| fingerprint-strings: 
|   DNSStatusRequestTCP, LANDesk-RC, LPDString, NULL, SSLSessionReq, TerminalServerCookie, ms-sql-s: 
|_    ERROR :Closing link: (unknown@192.168.49.196) [No more connections allowed from your host via this connect class (local)]
1 service unrecognized despite returning data. If you know the service/version, please submit the following fingerprint at https://nmap.org/cgi-bin/submit.cgi?new-service :
SF-Port6939-TCP:V=7.91%I=7%D=1/21%Time=61EAAFD5%P=x86_64-pc-linux-gnu%r(NU
...
SF:class\x20\(local\)\]\r\n")%r(LPDString,7B,"ERROR\x20:Closing\x20link:\x
...
SF:ms-sql-s,7B,"ERROR\x20:Closing\x20link:\x20\(unknown@192\.168\.49\.196\
...
# Nmap done at Fri Jan 21 08:06:45 2022 -- 1 IP address (1 host up) scanned in 23.81 seconds
