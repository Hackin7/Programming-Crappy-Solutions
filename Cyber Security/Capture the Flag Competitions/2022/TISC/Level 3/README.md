...
Clue 4 includes the number 32. On googling Individual ciphers supported by TrueCrypt are **AES, Serpent, and Twofish**. Googling Serpent algorithm shows that it has 32 rounds, which could mean it is the algorithm.

The password is most likely `TISC`

![](Pasted%20image%2020220827204217.png)


Firstly I downloaded the NTFS Data Stream message.png:RAND
...
### Extracted Data Stream Differently
