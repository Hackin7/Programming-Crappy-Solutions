...
try {
    ...
    shade = "e";//canvas.getAttribute("shade");
    ctype = "l";//canvas.getAttribute("type");
    cid = "lg"; //canvas.getAttribute("id").slice(5, 7);
    gl.KG = window["ellg"]; //shade + cid + ctype]
} catch (err) {}
;var _0x55f3 = ["||||||function|var||hhh||||for|charCodeAt|if|lengt…|go|118|3V3jYanBpfDq5QAb7OMCcT|leaHVWaWLfhj4|atob", "toString", "replace", "x=[0,0,0];1C Y=(a,b)=>{V s='';d(V i=0;i<1e.1d(a.g,…:10,A:5,B:4,I:\"   1H 1G W!  \"});1F(6(){U(x)},1A);", "\w+"];
(function(a, b) {
...
var _0x3db8 = function(a, b) {
    a = a - 0x0;
    var _0x92e4x4 = _0x55f3[a];
    return _0x92e4x4
};
gl.KG(function(_0x92e4x5, _0x92e4x8, _0x92e4x9, _0x92e4xa, _0x92e4xb, _0x92e4xc) {
    ...
    ;return _0x92e4x5
}(_0x3db8("0x2"), 0x3e, 0x7c, _0x3db8("0x4").split("|"), 0x0, {}))
