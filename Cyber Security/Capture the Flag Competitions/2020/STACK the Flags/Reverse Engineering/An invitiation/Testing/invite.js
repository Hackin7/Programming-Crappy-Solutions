...
var getFromArray2 = function(a, b) {
    return _0x55f3[a - 0x0];
};
/*
var data = function(aa, bb, cc, dd, ee, ff) {
    ee = function(hh) {
        return ( hh < bb ? "" : ee(parseInt(hh / bb)) ) + 
				((hh = hh % bb) > 35 ? String.fromCharCode(hh + 29) : hh.toString(36))
    }
    ;
    if (!"".replace(/^/, String)) {
        while (cc--) {
            ff[ee(cc)] = dd[cc] || ee(cc)
        }
        ;dd = [function(jj) {
            return ff[jj]
        }
	...
	while (cc--) {
        dd[cc] && (aa = aa.replace(new RegExp("" + ee(cc) + "","g"), dd[cc]))
    };
	return aa
	
}(getFromArray2("0x2"), 0x3e, 0x7c, getFromArray2("0x4").split("|"), 0x0, {});
*/
...
1 C Y = (a, b) => {
    V s = '';
    d(V i = 0; i < 1 e .1 d(a.g, b.g); i++) {
        s += q.p((a.e(i) || 0) ^ (b.e(i) || 0))
    }
    F s
};
f(u .19 == '1a:') {
...
f(Y(R.u .14, "T'13 1z!!!") == 1 y("%1E%1j%1q%17%1p%1o%1n%1m%1l%1i@M")) {
    x[1] = 1 k
}
S {
    x[1] = 1 r
...
6 U(h) {
    ...
    r = 1 Z("1X//k/1Y=");
    l = "";
    f(9. O(0, 2) == "1V" && 9. e(2) == 1 W && 9.1 U('1D-c') == 4) {
        d(i = 0; i < r.g; i++) {
            l += q.p(r.e(i) ^ L())
        }
        1 S("1T T d 1R 1Q 1P!\n" + 9 + l)
