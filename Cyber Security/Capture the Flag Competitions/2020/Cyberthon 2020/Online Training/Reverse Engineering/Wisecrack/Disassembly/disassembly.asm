...
00000883 <levelone>:
 ...
 889:	c7 45 e8 57 a0 8c e4 	mov    DWORD PTR [ebp-0x18],0xe48ca057
 890:	c7 45 ec 7b c8 77 6c 	mov    DWORD PTR [ebp-0x14],0x6c77c87b
 897:	c7 45 f0 af 83 6f 53 	mov    DWORD PTR [ebp-0x10],0x536f83af
 89e:	c7 45 f4 43 c7 01 12 	mov    DWORD PTR [ebp-0xc],0x1201c743
 8a5:	8d 45 d7             	lea    eax,[ebp-0x29]
 8a8:	89 45 f8             	mov    DWORD PTR [ebp-0x8],eax
 ...
 8ed:	8d 45 d7             	lea    eax,[ebp-0x29]
 8f0:	50                   	push   eax
 8f1:	68 35 0c 00 00       	push   0xc35
 8f6:	e8 fc ff ff ff       	call   8f7 <levelone+0x74>
 8fb:	83 c4 08             	add    esp,0x8
 8fe:	c7 45 fc 00 00 00 00 	mov    DWORD PTR [ebp-0x4],0x0
 905:	eb 2c                	jmp    933 <levelone+0xb0>
 907:	b8 03 00 00 00       	mov    eax,0x3
 90c:	2b 45 fc             	sub    eax,DWORD PTR [ebp-0x4]
 90f:	8b 54 85 e8          	mov    edx,DWORD PTR [ebp+eax*4-0x18]
 913:	8b 45 fc             	mov    eax,DWORD PTR [ebp-0x4]
 916:	8d 0c 85 00 00 00 00 	lea    ecx,[eax*4+0x0]
 91d:	8b 45 f8             	mov    eax,DWORD PTR [ebp-0x8]
 920:	01 c8                	add    eax,ecx
 922:	8b 00                	mov    eax,DWORD PTR [eax]
 924:	39 c2                	cmp    edx,eax
 926:	74 07                	je     92f <levelone+0xac>
 928:	b8 00 00 00 00       	mov    eax,0x0
 92d:	eb 0f                	jmp    93e <levelone+0xbb>
 92f:	83 45 fc 01          	add    DWORD PTR [ebp-0x4],0x1
 933:	83 7d fc 03          	cmp    DWORD PTR [ebp-0x4],0x3
...
00000940 <leveltwo>:
 ...
 9bf:	52                   	push   edx
 9c0:	50                   	push   eax
 9c1:	8d 45 e8             	lea    eax,[ebp-0x18]
 9c4:	50                   	push   eax
 9c5:	68 81 0c 00 00       	push   0xc81
 9ca:	e8 fc ff ff ff       	call   9cb <leveltwo+0x8b>
 9cf:	83 c4 24             	add    esp,0x24
 9d2:	c7 45 f0 00 00 00 00 	mov    DWORD PTR [ebp-0x10],0x0
 9d9:	eb 26                	jmp    a01 <leveltwo+0xc1>
 9db:	8d 55 e8             	lea    edx,[ebp-0x18]
 9de:	8b 45 f0             	mov    eax,DWORD PTR [ebp-0x10]
 9e1:	01 d0                	add    eax,edx
 9e3:	0f b6 00             	movzx  eax,BYTE PTR [eax]
 9e6:	0f be c0             	movsx  eax,al
 9e9:	83 e0 0f             	and    eax,0xf
 9ec:	0f b6 80 08 20 00 00 	movzx  eax,BYTE PTR [eax+0x2008]
 9f3:	8d 4d df             	lea    ecx,[ebp-0x21]
 9f6:	8b 55 f0             	mov    edx,DWORD PTR [ebp-0x10]
 9f9:	01 ca                	add    edx,ecx
 9fb:	88 02                	mov    BYTE PTR [edx],al
 9fd:	83 45 f0 01          	add    DWORD PTR [ebp-0x10],0x1
 a01:	83 7d f0 07          	cmp    DWORD PTR [ebp-0x10],0x7
 a05:	7e d4                	jle    9db <leveltwo+0x9b>
 a07:	c6 45 e7 00          	mov    BYTE PTR [ebp-0x19],0x0
 a0b:	68 92 0c 00 00       	push   0xc92
 a10:	8d 45 df             	lea    eax,[ebp-0x21]
 a13:	50                   	push   eax
 a14:	e8 fc ff ff ff       	call   a15 <leveltwo+0xd5>
 a19:	83 c4 08             	add    esp,0x8
 a1c:	85 c0                	test   eax,eax
 a1e:	74 07                	je     a27 <leveltwo+0xe7>
 a20:	b8 00 00 00 00       	mov    eax,0x0
 a25:	eb 05                	jmp    a2c <leveltwo+0xec>
 a27:	b8 01 00 00 00       	mov    eax,0x1
...
00000a34 <levelthree>:
 ...
 acf:	c7 45 fc 00 00 00 00 	mov    DWORD PTR [ebp-0x4],0x0
 ad6:	eb 20                	jmp    af8 <levelthree+0xc4>
 ad8:	8b 45 fc             	mov    eax,DWORD PTR [ebp-0x4]
 adb:	8b 54 c5 d8          	mov    edx,DWORD PTR [ebp+eax*8-0x28]
 adf:	8b 45 fc             	mov    eax,DWORD PTR [ebp-0x4]
 ae2:	8b 44 c5 d4          	mov    eax,DWORD PTR [ebp+eax*8-0x2c]
 ae6:	01 d0                	add    eax,edx
 ae8:	83 f8 0a             	cmp    eax,0xa
 aeb:	74 07                	je     af4 <levelthree+0xc0>
 aed:	b8 00 00 00 00       	mov    eax,0x0
 af2:	eb 0f                	jmp    b03 <levelthree+0xcf>
 af4:	83 45 fc 01          	add    DWORD PTR [ebp-0x4],0x1
 af8:	83 7d fc 04          	cmp    DWORD PTR [ebp-0x4],0x4
