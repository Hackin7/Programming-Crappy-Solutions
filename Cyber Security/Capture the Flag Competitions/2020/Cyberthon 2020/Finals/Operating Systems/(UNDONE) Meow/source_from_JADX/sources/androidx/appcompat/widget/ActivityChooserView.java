        ...
        public View getView(int i, View view, ViewGroup viewGroup) {
            ...
            if (itemViewType == 0) {
                ...
                if (view == null || view.getId() != 1) {
                    view = LayoutInflater.from(ActivityChooserView.this.getContext()).inflate(C0002R.layout.abc_activity_chooser_view_list_item, viewGroup, false);
                    view.setId(1);
                    ((TextView) view.findViewById(C0002R.C0004id.title)).setText(ActivityChooserView.this.getContext().getString(C0002R.string.abc_activity_chooser_view_see_all));
                }
                return view;
            } else {
                throw new IllegalArgumentException();
    ...
    public void showPopupUnchecked(int i) {
        if (this.mAdapter.getDataModel() != null) {
            ...
            if (!listPopupWindow.isShowing()) {
                ...
                listPopupWindow.getListView().setContentDescription(getContext().getString(C0002R.string.abc_activitychooserview_choose_application));
