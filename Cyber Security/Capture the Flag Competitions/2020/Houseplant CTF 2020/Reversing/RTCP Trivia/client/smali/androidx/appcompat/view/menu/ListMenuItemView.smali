...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    invoke-static {v0, p2, v1, p3, v2}, Lcr;->a(Landroid/content/Context;Landroid/util/AttributeSet;[III)Lcr;
    ...
    invoke-virtual {p2, p3, v2}, Lcr;->a(IZ)Z
    ...
    iget-object p2, p2, Lcr;->b:Landroid/content/res/TypedArray;
...
.method private setShortcut$25d965e(Z)V
    ...
    iget-object p1, p0, Landroidx/appcompat/view/menu/ListMenuItemView;->a:Lal;
    ...
    iget-object v2, p0, Landroidx/appcompat/view/menu/ListMenuItemView;->a:Lal;

    invoke-virtual {v2}, Lal;->c()C
    ...
    :cond_1
    iget-object v4, v2, Lal;->d:Laj;

    iget-object v4, v4, Laj;->a:Landroid/content/Context;
    ...
    iget-object v6, v2, Lal;->d:Laj;

    iget-object v6, v6, Laj;->a:Landroid/content/Context;
    ...
    sget v6, Lb$h;->abc_prepend_shortcut_label:I
    ...
    sget v7, Lb$h;->abc_menu_meta_shortcut_label:I

    invoke-virtual {v4, v7}, Landroid/content/res/Resources;->getString(I)Ljava/lang/String;

    move-result-object v7

    invoke-static {v5, v2, v6, v7}, Lal;->a(Ljava/lang/StringBuilder;IILjava/lang/String;)V

    const/16 v6, 0x1000

    sget v7, Lb$h;->abc_menu_ctrl_shortcut_label:I
    ...
    sget v7, Lb$h;->abc_menu_alt_shortcut_label:I
    ...
    sget v7, Lb$h;->abc_menu_shift_shortcut_label:I
    ...
    sget v7, Lb$h;->abc_menu_sym_shortcut_label:I
    ...
    sget v6, Lb$h;->abc_menu_function_shortcut_label:I

    invoke-virtual {v4, v6}, Landroid/content/res/Resources;->getString(I)Ljava/lang/String;

    move-result-object v6

    invoke-static {v5, v2, v0, v6}, Lal;->a(Ljava/lang/StringBuilder;IILjava/lang/String;)V
...
.method public final a(Lal;)V
    ...
    iput-object p1, p0, Landroidx/appcompat/view/menu/ListMenuItemView;->a:Lal;
    ...
    invoke-virtual {p1}, Lal;->isCheckable()Z
    ...
    invoke-virtual {p1}, Lal;->c()C

    if-eqz v1, :cond_1

    iget-object v1, p0, Landroidx/appcompat/view/menu/ListMenuItemView;->a:Lal;

    invoke-virtual {v1}, Lal;->d()Z
    ...
    iget-object v3, p0, Landroidx/appcompat/view/menu/ListMenuItemView;->a:Lal;

    invoke-virtual {v3}, Lal;->c()C
    ...
    :cond_2
    iget-object v5, v3, Lal;->d:Laj;

    iget-object v5, v5, Laj;->a:Landroid/content/Context;
    ...
    iget-object v7, v3, Lal;->d:Laj;

    iget-object v7, v7, Laj;->a:Landroid/content/Context;
    ...
    sget v7, Lb$h;->abc_prepend_shortcut_label:I
    ...
    sget v8, Lb$h;->abc_menu_meta_shortcut_label:I

    invoke-virtual {v5, v8}, Landroid/content/res/Resources;->getString(I)Ljava/lang/String;

    move-result-object v8

    invoke-static {v6, v3, v7, v8}, Lal;->a(Ljava/lang/StringBuilder;IILjava/lang/String;)V

    const/16 v7, 0x1000

    sget v8, Lb$h;->abc_menu_ctrl_shortcut_label:I
    ...
    sget v8, Lb$h;->abc_menu_alt_shortcut_label:I
    ...
    sget v7, Lb$h;->abc_menu_function_shortcut_label:I

    invoke-virtual {v5, v7}, Landroid/content/res/Resources;->getString(I)Ljava/lang/String;

    move-result-object v7

    invoke-static {v6, v3, v2, v7}, Lal;->a(Ljava/lang/StringBuilder;IILjava/lang/String;)V
    ...
    :cond_5
    sget v2, Lb$h;->abc_menu_space_shortcut_label:I

    goto :goto_3

    :cond_6
    sget v2, Lb$h;->abc_menu_enter_shortcut_label:I

    goto :goto_3

    :cond_7
    sget v2, Lb$h;->abc_menu_delete_shortcut_label:I
    ...
    invoke-virtual {p1}, Lal;->getContentDescription()Ljava/lang/CharSequence;
...
.method public getItemData()Lal;
    ...
    iget-object v0, p0, Landroidx/appcompat/view/menu/ListMenuItemView;->a:Lal;
...
.method protected onFinishInflate()V
    ...
    invoke-static {p0, v0}, Lgq;->a(Landroid/view/View;Landroid/graphics/drawable/Drawable;)V
...
.method public setCheckable(Z)V
    ...
    invoke-virtual {p1}, Lal;->isChecked()Z
