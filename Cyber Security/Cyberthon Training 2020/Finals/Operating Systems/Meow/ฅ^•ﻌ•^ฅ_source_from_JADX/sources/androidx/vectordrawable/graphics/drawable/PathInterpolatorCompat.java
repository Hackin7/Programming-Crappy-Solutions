...
public class PathInterpolatorCompat implements Interpolator {
    ...
    private void initPath(Path path) {
        ...
        if (min > 0) {
            this.f30mX = new float[min];
            this.f31mY = new float[min];
            ...
            if (((double) Math.abs(this.f30mX[0])) <= 1.0E-5d && ((double) Math.abs(this.f31mY[0])) <= 1.0E-5d) {
                int i3 = min - 1;
                if (((double) Math.abs(this.f30mX[i3] - 1.0f)) <= 1.0E-5d && ((double) Math.abs(this.f31mY[i3] - 1.0f)) <= 1.0E-5d) {
                    int i4 = 0;
                    float f = 0.0f;
                    while (i < min) {
                        float[] fArr2 = this.f30mX;
                        int i5 = i4 + 1;
                        float f2 = fArr2[i4];
                        if (f2 >= f) {
                            fArr2[i] = f2;
            ...
            sb2.append(this.f30mX[0]);
            String str = ",";
            sb2.append(str);
            sb2.append(this.f31mY[0]);
            sb2.append(" end:");
            int i6 = min - 1;
            sb2.append(this.f30mX[i6]);
            sb2.append(str);
            sb2.append(this.f31mY[i6]);
