...
undefined4 level1(){
  ...
  while( true ) {
    ...
    if (local_1c[3 - local_8] != *(int *)(local_c + local_8 * 4)){break;}
    local_8 = local_8 + 1;
  }
  return 0;
...
undefined4 leveltwo()
{
  ...
  printf("=> ");
  fflush(stdout);
  __isoc99_scanf("%c%c%c%c%c%c%c%c",local_1c,local_1c + 1,local_1c + 2,local_1c + 3,local_1c + 4,
                 local_1c + 5,local_1c + 6,local_1c + 7);
  local_14 = 0;
  while (local_14 < 8) {
    local_25[local_14] = map[(int)local_1c[local_14] & 0xf];
    local_14 = local_14 + 1;
  }
  local_1d = 0;
