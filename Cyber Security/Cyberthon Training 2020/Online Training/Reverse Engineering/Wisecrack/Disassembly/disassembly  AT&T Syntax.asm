...
000007fd <main>:;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
 ...
 828:   e8 56 00 00 00          call   883 <levelone> ;;;Check level 1
 82d:   83 f0 01                xor    $0x1,%eax
 830:   84 c0                   test   %al,%al
 832:   74 07                   je     83b <main+0x3e> ;;Jump if function says fail
 834:   b8 00 00 00 00          mov    $0x0,%eax
 839:   eb 46                   jmp    881 <main+0x84>
 83b:   e8 00 01 00 00          call   940 <leveltwo> ;;Check level 2
 840:   83 f0 01                xor    $0x1,%eax
 843:   84 c0                   test   %al,%al
 845:   74 07                   je     84e <main+0x51> ;;Jump if function says fail
 847:   b8 00 00 00 00          mov    $0x0,%eax
 84c:   eb 33                   jmp    881 <main+0x84>
 84e:   e8 e1 01 00 00          call   a34 <levelthree> ;;Check level 3
 853:   83 f0 01                xor    $0x1,%eax
 856:   84 c0                   test   %al,%al
 858:   74 07                   je     861 <main+0x64> ;;Jump if function says fail
 85a:   b8 00 00 00 00          mov    $0x0,%eax
 85f:   eb 20                   jmp    881 <main+0x84>
 861:   68 90 0b 00 00          push   $0xb90
 866:   e8 fc ff ff ff          call   867 <main+0x6a> ;;Printf?
...
00000883 <levelone>:;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
 ...
 8d7:   e8 fc ff ff ff          call   8d8 <levelone+0x55> ;;printf
 ...
 8fb:   83 c4 08                add    $0x8,%esp ;Move stack pointer down?
 8fe:   c7 45 fc 00 00 00 00    movl   $0x0,-0x4(%ebp)
 905:   eb 2c                   jmp    933 <levelone+0xb0>  ;;;;;;;;;;;;;;;;;;;Go and check;;;;;;;;;;;;;;;;;;
 907:   b8 03 00 00 00          mov    $0x3,%eax  ;;; Loop start
 ...
 926:   74 07                   je     92f <levelone+0xac> ;;Pass Condition
 928:   b8 00 00 00 00          mov    $0x0,%eax
 92d:   eb 0f                   jmp    93e <levelone+0xbb> ;;Fail condition
 92f:   83 45 fc 01             addl   $0x1,-0x4(%ebp)
 933:   83 7d fc 03             cmpl   $0x3,-0x4(%ebp);;;;;;;;;;;;Compare;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
 937:   7e ce                   jle    907 <levelone+0x84> ;;; while Loop if less than or equal 3?
